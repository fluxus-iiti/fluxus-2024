  ...
  return (
    <div>
      ...
      >
        <div
          id="bars"
          className="top-5 !z-[1000] cursor-pointer absolute  left-5 w-full h-fit m-5 font-weight-700 text-white text-2xl transition-all fade-in-out lg:hidden"
        >
          <FaBars
            className="sm:w-16 sm:h-16 h-10 w-10 cursor-pointer"
            onClick={() => {
