...
export default function OffCanvasNavbar() {
	...
	useEffect(() => {
		const handleClickOutsideOffCanvas = (e) => {
			...
			if ((!e.target.closest('#offcanvas') && !e.target.closest('#navbar')) || (e.target.closest('#offcanvas') && e.target.closest('#close_btn'))) {
	...
	return (
		<div
			...
			className={` py-4 transition-all  fade-in-out  absolute top-[-5000px] lg:hidden w-full   overflow-hidden  bg-black lg:bg-transparent bg-opacity-80 ${pathname == "/technicals" || pathname == "/sponsors" ? "!z-[1000000]" : "!z-[100000000]"}`}
		>
			...
			<div className="w-full lg:flex  justify-center border-0 border-red-500 !text-4xl ">
				...
				<div className="flex justify-center items-center  ">
					<div  className="top-0  absolute  left-0 w-fit h-full m-5 font-weight-700 text-white text-2xl transition-all fade-in-out lg:hidden cursor-pointer" onClick={() => {
						...
						<IoClose id="close_btn" className="sm:w-20 sm:h-20 h-16 w-16 cursor-pointer" />
					</div>
				...
				<div className="w-full flex flex-col lg:flex-row justify-end items-center lg:hidden">
					...
					<div className="md:mx-5 my-5 font-bold mx-10  !text-4xl md:my-auto hover:border-b-2 transition-all fade-in-out hover:!text-gray-300">
						<Link target={"_blank"} className="text-2xl" href="https://www.townscript.com/e/fluxus">Workshop</Link>
					</div>
					<div className="md:mx-5 my-5 font-bold mx-10  !text-4xl md:my-auto hover:border-b-2 transition-all fade-in-out hover:!text-gray-300">
					...
					<div className={`md:mx-5 my-5 font-bold mx-10  !text-4xl md:my-auto transition-all fade-in-out hover:!text-gray-300 hover:border-b-2 backdrop-blur-md md:backdrop-blur-none`}>
						<Link target={"_blank"} className="text-2xl" href="https://ca.fluxus.co.in/">CA Fluxus</Link>
					</div>
