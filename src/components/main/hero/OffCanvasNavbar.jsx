...
export default function OffCanvasNavbar() {
	...
	return (
		<div
			id="offcanvas"
			className={` py-4 transition-all fade-in-out  absolute top-[-5000px] lg:hidden w-full   overflow-hidden  bg-black lg:bg-transparent bg-opacity-80 ${pathname=="/technicals"?"!z-[1000000]":""}`}
		>
