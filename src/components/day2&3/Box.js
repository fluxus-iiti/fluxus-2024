  ...
  return (
    <div className="flex-1 flex flex-wrap justify-center w-1/2">
      <div className=" h-fit w-2/3 shadow-md border border-white relative text-center">
        <div className="bg-black h-6 w-6 border rounded-full border-t-black border-l-black border-r-white absolute -top-[5px] -left-[5px]"></div>
        <div className="bg-black h-6 w-6 border rounded-full border-t-black border-l-white border-b-white border-r-black  absolute -top-[5px] -right-[5px]"></div>
        {/* <img
        ...
        <div className="bg-black h-6 w-6 border rounded-full border-t-white border-l-white border-b-black border-r-black absolute -bottom-[5px] -right-[5px]"></div>
        <div className="bg-black h-6 w-6 border rounded-full border-t-white border-l-black border-b-black border-r-white absolute -bottom-[5px] -left-[5px]"></div>
      </div>
    </div>
  );
};
