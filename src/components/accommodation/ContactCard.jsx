              ...
              <div className="grid grid-rows-[auto_auto]  ">
                <div className=" px-10 py-5 w-full flex flex-col justify-center items-center">
                  ...
                  <div className="w-fit md:w-full h-full ml-5">
                    <div className="my-2 text-4xl   text-white rounded-lg text-center break-all p-2  font-bold">
                      {ele.name}
                    </div>
                    <div className="my-2  text-3xl font-bold text-white rounded-lg text-center break-all p-2 ">
                      {ele.position}
                    </div>
                    <div className="mt-2  text-2xl font-bold text-white rounded-lg text-center break-all p-2 ">
                ...
                <div className="w-full  text-white text-center p-5 !h-full">
                  <div className="mb-5 flex">
                    ...
                    >
                      <a href={`tel:+91${ele.phone}`}>{ele.phone}</a>
                    </div>
